...
tags: ["tea plantation", "wayanad", "mountain", "cottage", "nature", "spice processing", "organic"],
    ...
    },
    {
      ...
      image: [iconURLPrefix+"assets/img/plantation/bw-stays-coffee-estate-forest.webp"],
      holidays: "Mon",
      timing:[ "09:00-17:00"],
  ...
  waterfalls: [
    {
      ...
      image: [iconURLPrefix+"assets/img/falls/bw-stays-meenmutty-homestay-wayanad.webp",iconURLPrefix+"assets/img/falls/bw-stays-meenmutty-waterfall-wayanad.webp",iconURLPrefix+"assets/img/falls/bw_meenmufalls_wayanad2.avif",iconURLPrefix+"assets/img/falls/bw-stays-meenmutty-falls-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["kalpetta", "waterfalls","canals", "lakes", "lagoons", "tranquil", "authentic"],      type: "Water Falls",
...
},
    {
      ...
      description: "Also known as Sentinel Rock Waterfalls, perfect for trekking and rock climbing.",
      image: [iconURLPrefix+"assets/img/falls/bw-service-apartment-soochipara-wayanad.webp",iconURLPrefix+"assets/img/falls/bw-homestay-soojipara-waterfalls-wayanad.avif"],
      holidays: "Sun",
      timing:[ "08:00-16:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["kalpetta", "waterfalls","canals", "lakes", "lagoons", "tranquil", "authentic"],      type: "Water Falls",
...
},
    {
      ...
      description: "Also known as Sentinel Rock Waterfalls, perfect for trekking and rock climbing.",
      image: [iconURLPrefix+"assets/img/falls/black-and-white-chethalayam-falls-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
,

      {
       ...
       name: "Arripara falls",
       description: "Also known as Sentinel Rock Waterfalls, perfect for trekking and rock climbing.",
       image: [iconURLPrefix+"assets/img/falls/bw-stays-arripa-falls-kalpetta.webp"],
       holidays: "Sun",
       timing:[ "09:00-17:00"],
       Contact: "+91-000 000 0000",
 	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["kalpetta", "waterfalls","canals", "lakes", "lagoons", "tranquil", "authentic"],
    ...
    duration : "1-2 Hours",
},
      {
       ...
       name: "Irrupu falls ",
       description: "Also known as Sentinel Rock Waterfalls, perfect for trekking and rock climbing.",
       image: [iconURLPrefix+"assets/img/falls/bw-stays-irupu-falls-wayanad-inn.webp"],
       holidays: "Sun",
       timing:[ "09:00-17:00"],
       Contact: "+91-000 000 0000",
 	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
,
      {
       ...
       description: "Also known as Sentinel Rock Waterfalls, perfect for trekking and rock climbing.",
       image: [iconURLPrefix+"assets/img/falls/bw-stays-chethalayam-waterfall-homestay.webp",iconURLPrefix+"assets/img/falls/black-and-white-chethalayam-falls-wayanad.webp"],
       holidays: "Sun",
       timing:[ "09:00-17:00"],
       Contact: "+91-000 000 0000",
 	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["kalpetta", "waterfalls","canals", "lakes", "lagoons", "tranquil", "authentic"],
...

 {
      ...
      image: [iconURLPrefix+"assets/img/falls/bw-stays-thusharagiri-falls-service-apartment.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
,
    {
      ...
      image: [iconURLPrefix+"assets/img/museum/bw-guesthouse-wayanad-heritage-museum-ambalavayal.webp",iconURLPrefix+"assets/img/museum/bw-stays-wayanad-heritage-homestay.webp", iconURLPrefix+"assets/img/museum/bw-stays-wayanad-heritage-museum.webp"],
      holidays: "Sun",
      timing:[ "09:00-18:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
  ...
  romantic: [
{
      ...
      image: [iconURLPrefix+"assets/img/romantic/bw-stays-mullanpara-viewpoint-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-18:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...

{
       ...
       name: "Karland Lake",
       description: "Also known as Sentinel Rock Waterfalls, perfect for trekking and rock climbing.",
       image: [iconURLPrefix+"assets/img/romantic/bw-stays-karlad-lake-wayanad-tourism.webp",iconURLPrefix+"assets/img/romantic/bw-rooms-karlad-lake-wayanad.webp"],
       holidays: "Sun",
       timing:[ "09:00-17:00"],
       Contact: "+91-000 000 0000",
 	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Ghats", "kalpetta", "Deccan Plateau", "seafood", "yoga", "cliff", "ayurvedic", "spice shops"],
    ...
    ,
    {
      ...
      image: [iconURLPrefix+"assets/img/romantic/bw-staycation-banasura-sagar-wayanad.webp", iconURLPrefix+"assets/img/romantic/bw-resort-banasura-sagar-dam-homestay.webp", iconURLPrefix+"assets/img/romantic/bw-stays-banasura-sagar-dam-wayanad.avif"],
      holidays: "Sun",
      timing:[ "06:00-17:30"],
    ...
    ,
    {
      ...
      name: "Mailadippara",
      description: "A picturesque waterfall surrounded by lush greenery and coffee plantations.",
      image: [iconURLPrefix+"assets/img/romantic/black-and-white-mailadanpara-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Ghats", "kalpetta", "Deccan Plateau", "seafood", "yoga", "cliff", "ayurvedic", "spice shops"],
    ...
    ,
    {
      ...
      name: "Manjappara",
      description: "A picturesque waterfall surrounded by lush greenery and coffee plantations.",
      image: [iconURLPrefix+"assets/img/romantic/bw-holiday-longstay-manjapara-viewpoint.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Ghats", "kalpetta", "Deccan Plateau", "seafood", "yoga", "cliff", "ayurvedic", "spice shops"],
    ...
    ,
    {
      ...
      name: "Kurumbalakotta",
      description: "A picturesque waterfall surrounded by lush greenery and coffee plantations.",
      image: [iconURLPrefix+"assets/img/romantic/bw-weekend-kurumbalakotta-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Ghats", "kalpetta", "Deccan Plateau", "seafood", "yoga", "cliff", "ayurvedic", "spice shops"],
    ...
    ,
    {
      ...
      description: "A picturesque waterfall surrounded by lush greenery and coffee plantations.",
      image: [iconURLPrefix+"assets/img/romantic/bw-kalpetta-neelimala-view-point-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Ghats", "kalpetta", "Deccan Plateau", "seafood", "yoga", "cliff", "ayurvedic", "spice shops"],
    ...
    ,
    {
      ...
      description: "A picturesque waterfall surrounded by lush greenery and coffee plantations.",
      image: [iconURLPrefix+"assets/img/romantic/bw-lakkidi-view-point-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Ghats", "kalpetta", "Deccan Plateau", "seafood", "yoga", "cliff", "ayurvedic", "spice shops"],
...
},
  {
          ...
          image: [iconURLPrefix+"assets/img/romantic/black-and-white-nellarachal-wayanad.webp"],
          holidays: "Sun",
          timing:[ "09:00-17:00"],
          Contact: "+91-000 000 0000",
     	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Ghats", "kalpetta", "Deccan Plateau", "seafood", "yoga", "cliff", "ayurvedic", "spice shops"],
...

  {
        ...
        description: "Sample",
        image: [iconURLPrefix+"assets/img/romantic/bw-muneeswarankunnu-muneeswaran-wayanad.webp"],
        holidays: "Sun",
        timing:[ "10:00-21:00"],
        Contact: "+91-000 000 0000",
  	  seasontovisit:["All Season"],
...
,
    {
      ...
      description: "Temple associated with the epic Ramayana, located in a serene setting.",
      image: [iconURLPrefix+"assets/img/heritage/bw-stays-pazhassi-tomb-wayanad-resort.webp",iconURLPrefix+"assets/img/heritage/bw-workation-pazhassi-tomb-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["heritage", "mountains", "traditional", "kerala", "cuisine", "spice", "quiet", "relaxed"],
...
},
 {
           ...
           image: [iconURLPrefix+"assets/img/heritage/bw-stays-shanthinatha-jain-temple-kalpetta.webp",iconURLPrefix+"assets/img/heritage/bw-stays-shanthinatha-jain-temple-wayanad.webp",iconURLPrefix+"assets/img/heritage/bw-homestay-shanthinatha-jain-temple-wayanad.webp"],
           holidays: "Sun",
           timing:[ "08:00-17:30"],
           Contact: "+91-000 000 0000",
...
,
   {
         ...
         image: [iconURLPrefix+"assets/img/trucking/bw-weekend-destination-cheengeri-hills.webp"],
         holidays: "Sun",
         timing:[ "06:00-17:00"],
         Contact: "+91-000 000 0000",
   		  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
,
    {
      ...
      name: "Edakal Caves",
      description: "Temple associated with the epic Ramayana, located in a serene setting.",
      image: [iconURLPrefix+"assets/img/trucking/bw-staycation-edakkal-caves-wayanad.webp",iconURLPrefix+"assets/img/trucking/bw-homestay-kerala-wayanad-edakkal-caves.webp"],
      holidays: "Mon",
      timing:[ "08:30-16:00"],
...
,

   {
      ...
      image: [iconURLPrefix+"assets/img/trucking/bw-service-villa-kolagappara-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
},
{
      ...
      image: [iconURLPrefix+"assets/img/wildlife/bw-weekday-pakshipathalam-bird-sanctuary-wayanad.webp",iconURLPrefix+"assets/img/wildlife/bw-villas-pakshipathalam-wayanad.webp"],
      holidays: "None",
      timing:[ "07:00-17:00"],
      Contact: "+91-333 333 3333",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Pakshipathalam", "wildlife", "sanctuary", "elephants", "tigers", "birds", "spice plantations", "nature", "adventure"],
...
},
 {
      ...
      description: "Showcases the rich cultural heritage and tribal artifacts of Wayanad.",
      image: [iconURLPrefix+"assets/img/wildlife/bw-team-event-tholpetty-wildlife-sanctuary-wayanad.webp"],
      holidays: "Sun",
...
tags: ["Tholpetty", "wildlife", "sanctuary", "elephants", "tigers", "birds", "spice plantations", "nature", "adventure"],
...

 {
      ...
      description: "Showcases the rich cultural heritage and tribal artifacts of Wayanad.",
      image: [iconURLPrefix+"assets/img/wildlife/bw-kerala-begur-wildlife-sanctuary-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
  ...
  farms: [
       {
	      ...
	      image: [iconURLPrefix+"assets/img/farm/bw-gurukula-botanical-sanctuary-wayanad.webp"],
	      holidays: "None",
	      timing:[ "10:00-16:00"],
...
tags: ["Family Farm Day", "Agri Education", "Farm Fun", "Eco Tourism", "Educational Farm", "HandsOnLearning"],
...

    {
      ...
      name: "Ambalavayal",
      description: "Showcases the rich cultural heritage and tribal artifacts of Wayanad.",
      image: [iconURLPrefix+"assets/img/farm/bw-stays-rars-wayanad-ambalavayal.webp"],
      holidays: "Sun",
      timing:[ "09:00-16:30"],
...
tags: ["Family Farm Day", "Agri Education", "Farm Fun", "Eco Tourism", "Educational Farm", "HandsOnLearning"],
...
},
    {
      ...
      image: [iconURLPrefix+"assets/img/farm/bw-stays-boys-town-farm-wayanad.webp"],
      holidays: "None",
      timing:[ "08:00-18:00"],
      Contact: "+91-444 444 4444",
	  seasontovisit:["All Season"],
...
tags: ["Family Farm Day", "Agri Education", "Farm Fun", "Eco Tourism", "Educational Farm", "HandsOnLearning"],
  ...
  sporting: [
  {
            ...
            image: [iconURLPrefix+"assets/img/sports/bw-stay-bamboo-sport-rafting-wayanad.webp"],
            holidays: "Sun",
            timing:[ "09:00-16:30"],
  ...
  cycling: [
{
          ...
          image: [iconURLPrefix+"assets/img/cycling/bw-stays-resort-wayanad-cycle-workation.webp"],
          holidays: "Sun",
          timing:[ "09:00-17:00"],
          Contact: "+91-000 000 0000",
     	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Cycling", "Challenging Terrain", "Stay visible", "cyclists", "healthy", "adventure tour"],
      ...
      duration : "1-2 Hours",
},
        {
          ...
          image: [iconURLPrefix+"assets/img/cycling/bw-stays-chundale-cycling-group-wayanad.webp",iconURLPrefix+"assets/img/cycling/bw-stays-chundale-cycling-hotel-wayanad.avif",iconURLPrefix+"assets/img/cycling/bw-stays-resort-wayanad-cycle-workation.webp" ,iconURLPrefix+"assets/img/cycling/bw-hotel-stays-chundale-wayanad.webp"],
          holidays: "Sun",
          timing:[ "09:00-17:00"],
          Contact: "+91-000 000 0000",
...
tags: ["spice shopping", "guided tours", "local markets", "cardamom", "pepper", "cinnamon", "kerala cuisine"],
...

    {
      ...
      image: [iconURLPrefix+"assets/img/shopping/bw-whole-spices-wholesale-kalpetta-wayanad.webp"],
      holidays: "None",
      timing:[ "11:00-23:00"],
      Contact: "+91-555 555 5555",
	  seasontovisit:["All Season"],
 ...
 pilgrimage: [
{
          ...
          name: "Tirunelli",
          description: "Ancient temple dedicated to Lord Vishnu, nestled in the hills of Wayanad.",
          image: [iconURLPrefix+"assets/img/pilgrimage/bw-stays-tirunelli-temple-wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-stays-thirunelli-temple_wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-stays-thirunelli-temple-wayanad.webp"],
          holidays: "Sun",
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
...
},
    {
          ...
          image: [iconURLPrefix+"assets/img/pilgrimage/bw-workation-jain-glass-temple-wayanad.webp"],
          holidays: "Sun",
          timing:[ "09:00-18:30"],
          Contact: "+91-000 000 0000",
    	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
        ...
        duration : "1-2 Hours",
...

     	{
          ...
          image: [iconURLPrefix+"assets/img/pilgrimage/bw-stays-papanasini-wayanad-tourist.webp",iconURLPrefix+"assets/img/pilgrimage/bw-staycation-papanashini-wayanad.webp", iconURLPrefix+"assets/img/pilgrimage/bw-stays-papanasini-thirunelli-wayanad.webp"],
          holidays: "Sun",
          timing:["05:30-12:30","17:00-19:30"],
          Contact: "+91-000 000 0000",
    	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...

{
      ...
      image: [iconURLPrefix+"assets/img/pilgrimage/bw-staycation-meenagadhi-church-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
    ...
    duration : "1-2 Hours",
},
 	{
      ...
      image: [iconURLPrefix+"assets/img/pilgrimage/bw-stays-pallikunnu-church-wayanad.webp", iconURLPrefix+"assets/img/pilgrimage/bw-workation-pallikkunnu-church-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
    ...
    duration : "1-2 Hours",
},
 	{
      ...
      image: [iconURLPrefix+"assets/img/pilgrimage/bw-stays-trikaipattta-temple-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
...
},
    {
      ...
      image: [iconURLPrefix+"assets/img/pilgrimage/bw-workation-trishilerry-temple-wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-stays-trishilerry-temple-wayanad.webp"],
      holidays: "Sun",
      timing:["05:30-12:30","17:00-19:30"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
...

    {
      ...
      description: "Temple associated with the epic Ramayana, located in a serene setting.",
      image: [iconURLPrefix+"assets/img/pilgrimage/bw-stays-lava-kush-ponkuzhi-wayanad.webp",iconURLPrefix+"bw-seetha-lava-kusha-temple-wayanad.webp",iconURLPrefix+"bw-stays-lav-kush-temple-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
...

    {
      ...
      image: [iconURLPrefix+"assets/img/pilgrimage/bw-stays-korome-mosque-wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-stays-varambetta-mosque-wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-workation-korome-mosque-wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-stays-wayanad-varambetta-mosque.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
    ...
    ,
    {
      ...
      description: "Temple associated with the epic Ramayana, located in a serene setting.",
      image: [iconURLPrefix+"assets/img/pilgrimage/bw-valliyurkavu-bhagavathy-temple-wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-stays-resort-valliyurkavu-wayanad.avif",iconURLPrefix+"assets/img/pilgrimage/bw-valliyoorkavu-homestay-wayanad.webp",iconURLPrefix+"assets/img/pilgrimage/bw-valliyoorkavu-bhagavathy-temple-wayanad.webp"],
      holidays: "Sun",
      timing:[ "09:00-17:00"],
      Contact: "+91-000 000 0000",
	  seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
...
tags: ["Church", "temple", "mosque", "yoga", "festivals"],
  ...
  stays: [
  		{
  			...
  			image: [iconURLPrefix+"assets/img/stays/bw-stays-old-kalpetta-town.webp"],
  			holidays: "Sun",
  			timing:[ "09:00-17:00"],
  			Contact: "+91-000 000 0000",
  			seasontovisit:["Summer (March-May)","Monsoon (June-September)","Winter (October-February)"],
  			...
  			},
    {
        ...
        name: "Manathavady",
        description: "Sample",
        image: [iconURLPrefix+"assets/img/stays/bw-stays-manathavady.webp"],
        holidays: "Sun",
        timing:[ "10:00-21:00"],
        Contact: "+91-000 000 0000",
  	  seasontovisit:["All Season"],
  ...
  tags: ["spice shopping", "guided tours", "local markets", "cardamom", "pepper", "cinnamon", "kerala cuisine"],
  ...
  },
    {
        ...
        name: "Sulthan Batery",
        description: "Sample",
        image: [iconURLPrefix+"assets/img/stays/bw-stays-sulthan-bathery.webp"],
        holidays: "Sun",
        timing:[ "10:00-21:00"],
        Contact: "+91-000 000 0000",
  	  seasontovisit:["All Season"],
