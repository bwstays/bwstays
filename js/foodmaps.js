				  ...
				  if (status === google.maps.places.PlacesServiceStatus.OK && place) {
					...
					let placeHTML = `
					  <div class="mb-4 text-right">
						...
						<a href="https://www.google.com/maps/dir/?api=1&origin_place_id=${results[i].place_id}&destination_place_id=${detailsRequest.placeId}" alt="location map" target="_blank" rel="noopener noreferrer nofollow" > <p class="text-white-50 small mb-1">
