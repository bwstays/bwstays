  ...
  descContainer.innerHTML = `
      ...
      <div class="mb-3">
          <small class="text-white-50">
            ...
            <li><img title="Black and White Stays Service Villa"  alt="Black and White Stays Wayanad"  width="20" height="20" src="https://www.bwstays.com/assets/img/icons/cloudy.png"  />Weather: <span id="temperature"></span> </li>
            </ul>
        </small>
      </div>
      <div class="mb-3">
